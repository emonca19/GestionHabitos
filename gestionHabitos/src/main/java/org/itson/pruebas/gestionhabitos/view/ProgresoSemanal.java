...
public class ProgresoSemanal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSemanal.setBorderPainted(false);
        btnSemanal.setContentAreaFilled(false);
        btnSemanal.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnSemanal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSemanalActionPerformed(evt);
            }
        });
        add(btnSemanal, new org.netbeans.lib.awtextra.AbsoluteConstraints(616, 198, 110, 43));
...
// Panel personalizado para cada hábito
    private class HabitPanel extends JPanel {
        ...
        public HabitPanel(String habitName) throws FontFormatException, IOException {
            ...
            JLabel diasLabel = new JLabel("5/7");
            ...
            // Barra de progreso
            JProgressBar jpb = new JProgressBar(0, 7);  // Rango de la barra
            jpb.setValue(5);  // Valor actual (puedes cambiarlo dinámicamente)
    ...
    private void setFonts() throws IOException, FontFormatException {
