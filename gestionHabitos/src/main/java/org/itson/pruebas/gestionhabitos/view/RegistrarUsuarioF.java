 ...
 * @author user
 */
public class RegistrarUsuarioF extends javax.swing.JFrame {

    private final ImageIcon backgroundImage;

    /**
     * Creates new form InicioSesionF
     */
    public RegistrarUsuarioF() {
        initComponents();
        backgroundImage = new ImageIcon("src/main/resources/img/background.png");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        new InicioSesionF().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarUsuarioF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarUsuarioF().setVisible(true);
            }
        });
    }
