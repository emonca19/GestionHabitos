 ...
 *
 * <p>
 * Utiliza la configuración definida en el archivo {@code persistence.xml} para establecer la conexión con la base de datos.</p>
 *
 * @author Eliana Monge
...
public class Conexion implements IConexion {
    ...
    public EntityManager crearConexion() {
        EntityManagerFactory emFactory = Persistence.createEntityManagerFactory("gestionHabitos");
