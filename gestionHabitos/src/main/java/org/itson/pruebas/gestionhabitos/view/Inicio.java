...
//            Logger.getLogger(Inicio.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void listarHabitosPendientes() throws FontFormatException, IOException {
        ...
        try {
            ...
            //TODO
            List<HistorialHabitosDTO> habitos = obtenerHistorial(new Date());
            ...
            if (habitos.isEmpty()) {
                ...
                for (HistorialHabitosDTO habito : habitos) {
    ...
    private void addHabit(HistorialHabitosDTO habitoDTO) throws FontFormatException, IOException {
        String habitName = habitoDTO.getHabito().getNombre(); // Obtener el nombre del hábito desde el DTO
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    if (!habit.isCompleted()) {
                        ...
                        registrarHabito(habitoDTO.getHabito(), true); // Pasar el HabitoDTO
                    } else {
                        // Mover de realizados a pendientes
                        pnlHabitosRealizados.remove(habit);
                        pnlHabitosPendientes.add(habit);
                        habit.setCompleted(false);
                        registrarHabito(habitoDTO.getHabito(), false); // Pasar el HabitoDTO
