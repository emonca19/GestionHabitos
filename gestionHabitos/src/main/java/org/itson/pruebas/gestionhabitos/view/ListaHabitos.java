...
public class ListaHabitos extends javax.swing.JPanel {
    ...
    private void addHabit(HabitoDTO habitoDTO, JPanel parentPanel) throws FontFormatException, IOException {
        HabitPanel habit = new HabitPanel(habitoDTO);
...
// Panel personalizado para cada hábito
    private class HabitPanel extends JPanel {
        ...
        public HabitPanel(HabitoDTO habitoDTO) throws FontFormatException, IOException {
            ...
            JLabel nameLabel = new JLabel("• " + habitoDTO.getNombre());  // Añadir la viñeta '•' y un espacio
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    mostrarVerHabito(habitoDTO);  // Llamar al método que muestra el panel VerHabito
                }
            });
        }
    }

    private void mostrarVerHabito(HabitoDTO habitoDTO) {
        ...
        VerHabito pnlVerHabito = new VerHabito(frame, dialog, habitoDTO);  // Pasar el nombre del hábito, si es necesario
