 ...
 * @author user
 */
public class InicioSesionF extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioSesionF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
